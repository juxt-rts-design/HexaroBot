...
export function Icon({ name, size = 18, className = '', strokeWidth = 2 }) {
  ...
  const paths = {
    ...
    google: (
      <>
        <path d="M12 11v2.4h3.9c-.2 1-.7 1.8-1.5 2.3v1.9h2.4c1.4-1.3 2.2-3.2 2.2-5.5 0-.5 0-1-.1-1.5H12z" fill="currentColor" stroke="none" />
        <path d="M5.3 14.3l-.7.5 2 1.6c.8-2.3 2.8-4 5.4-4 .9 0 1.8.2 2.6.6l2-2A8.5 8.5 0 0 0 5.3 14.3z" fill="currentColor" stroke="none" />
      </>
    ),
    plus: (
      <>
    ...
    refresh: (
      <>
        ...
        <path d="M20.5 14a8 8 0 1 1-1.9-7.2L23 10" />
      </>
    ),
  };
